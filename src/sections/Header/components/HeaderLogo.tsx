...
export const HeaderLogo = ({ scrolled = false }: HeaderLogoProps) => {
  return (
    <div className="caret-transparent min-h-[auto] min-w-[auto] outline-[3px] no-underline">
      <div className="items-center caret-transparent flex text-[0px] justify-center leading-[0px] outline-[3px] no-underline">
        <div className="caret-transparent min-h-[auto] min-w-[auto] outline-[3px] no-underline">
          <a href="/" className="caret-transparent outline-[3px] no-underline">
            <div className="caret-transparent hidden max-h-[25px] outline-[3px] no-underline md:block">
              <img
                ...
                className={`box-border caret-transparent inline max-h-[25px] max-w-full outline-[3px] no-underline align-top transition-[filter] duration-300 ${
            ...
            <div className="caret-transparent block max-h-5 outline-[3px] no-underline md:hidden">
              <img
                ...
                className={`box-border caret-transparent inline max-h-5 max-w-full outline-[3px] no-underline align-top transition-[filter] duration-300 ${
                  scrolled ? "" : "brightness-0 invert"
                }`}
              />
            </div>
