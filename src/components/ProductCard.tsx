...
export const ProductCard = (props: ProductCardProps) => {
  return (
    <li className="caret-transparent text-neutral-500 block list-none min-h-[auto] min-w-[auto] outline-[3px] no-underline align-top w-full">
      <div className="caret-transparent outline-[3px] no-underline">
        <div className="caret-transparent outline-[3px] relative text-center no-underline mb-4">
          <div
            className={`items-center bg-zinc-600 box-border caret-transparent gap-x-1.5 hidden justify-center max-w-[190px] outline-[3px] absolute gap-y-1.5 no-underline text-nowrap w-[90%] z-10 p-[5px] rounded-bl rounded-br rounded-tl rounded-tr left-1.5 md:w-full md:p-1.5 md:left-3 ${props.badgeClassName}`}
          >
            <img
              src="https://c.animaapp.com/mq3f9bhuPsGnIl/assets/icon-11.svg"
              alt="Icon"
              className="box-border caret-transparent text-white inline h-3.5 outline-[3px] no-underline text-nowrap align-baseline w-3.5"
            />
            <div className="items-center caret-transparent gap-x-1.5 flex outline-[3px] gap-y-1.5 no-underline text-nowrap"></div>
          </div>
          <div className="caret-transparent outline-[3px] no-underline">
            <a
            ...
            >
              <img
                src={props.imageUrl}
                alt=""
                className="box-border caret-transparent inline max-w-full outline-[3px] relative no-underline w-full"
              />
            </a>
          ...
          <div className="caret-transparent gap-x-1.5 flex flex-col opacity-100 outline-[3px] absolute gap-y-1.5 no-underline transform-none z-[90] p-2.5 right-0 bottom-0 md:opacity-0 md:translate-y-2.5 md:p-0 md:right-2.5 md:bottom-2.5">
        ...
        <div className="caret-transparent text-xs leading-[18px] outline-[3px] no-underline mt-2.5 md:mt-0">
          <div className="caret-transparent outline-[3px] no-underline mb-3">
            ...
            >
              <span className="caret-transparent text-zinc-900 hidden text-sm font-semibold leading-[16.8px] outline-[3px] no-underline mb-[17px] md:text-base md:leading-[19.2px]">
                <span className="caret-transparent text-sm leading-[16.8px] outline-[3px] no-underline md:text-base md:leading-[19.2px]">
                  상품명
                </span>
                :
              </span>
              <span className="caret-transparent text-zinc-900 text-sm font-semibold leading-[16.8px] outline-[3px] no-underline md:text-base md:leading-[19.2px]">
                {props.productName}
              </span>
            </a>
          </div>
          <ul className="caret-transparent list-[circle] outline-[3px] no-underline pl-0">
            <li className="caret-transparent leading-[19px] list-none outline-[3px] no-underline mb-3">
              <strong className="caret-transparent hidden font-bold outline-[3px] no-underline">
                <span className="caret-transparent text-neutral-400 text-[15px] outline-[3px] no-underline">
                  특징
                </span>
                :
              </strong>
            ...
            <li className="caret-transparent inline-block leading-[19px] list-none outline-[3px] no-underline mr-[5px]">
              <strong className="caret-transparent hidden font-bold outline-[3px] no-underline">
                <span className="caret-transparent text-zinc-400 text-[15px] outline-[3px] no-underline">
                  소비자가
                </span>
                :
              </strong>
            ...
            <li className="caret-transparent inline-block leading-[19px] list-none outline-[3px] no-underline">
              <strong className="caret-transparent hidden font-bold outline-[3px] no-underline">
                <span className="caret-transparent text-black text-[19px] outline-[3px] no-underline">
                  판매가
                </span>
                :
              </strong>
